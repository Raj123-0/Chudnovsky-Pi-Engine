"""Unit tests for Chudnovsky-Pi-Engine."""
import importlib
import sys
import unittest
...
class TestImport(unittest.TestCase):
    ...
    def test_module_imports(self):
        ...
        try:
            importlib.import_module("Chudnovsky_Pi_Engine")
    ...
    def test_module_has_functions(self):
        ...
        try:
            mod = importlib.import_module("Chudnovsky_Pi_Engine")
        except ImportError as e:
            if "gmpy2" in str(e) or "mpmath" in str(e):
                self.skipTest(f"Optional dependency not installed: {e}")
            raise
...
class TestArguments(unittest.TestCase):
    ...
    def test_help_flag_exists(self):
        ...
        import ast
        import os
        script_path = os.path.join(os.path.dirname(__file__), "..", "Chudnovsky Pi Engine.py")
